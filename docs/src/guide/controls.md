...
| Mode | Behavior |
|------|----------|
| **Centered** | Display at native 256x240 resolution, centered in the window. No scaling. |
...
When the configuration panel is closed, the current frame rate is shown in the top-left corner of the window.
